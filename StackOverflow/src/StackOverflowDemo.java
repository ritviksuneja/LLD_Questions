...
public class StackOverflowDemo {
    public static void main(String[] args){
        ...
        //Alice asks question
        Question javaQuestion = system.askQuestion("What is polymorphism in java?", 
            "Can someone please explain polymorphism in java with examples?", 
            alice, 
        ...
        system.voteEntity(charlie, javaQuestion, 1);  // Upvote
        system.voteEntity(charlie, bobAnswer, 1);  // Upvote

        // Alice accepts Bob's answer
        system.acceptAnswer(alice, bobAnswer);

        // Bob asks another question
        Question pythonQuestion = system.askQuestion("How to use list comprehensions in Python?",
        ...
        system.voteEntity(charlie, pythonQuestion, 1);  // Upvote
        system.voteEntity(charlie, aliceAnswer, 1);  // Upvote
